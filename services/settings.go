...
func InitDefaultSettings() {
	defaults := map[string]string{
		...
		"pdf_clause_conditions_utilisation": "Le matériel est loué à titre strictement personnel et ne peut en aucun cas être prêté ou cédé à un tiers. Le matériel loué reste la propriété exclusive et insaisissable du Club. L'adhérent s'engage à utiliser le matériel exclusivement pour la pratique du tir à l'arc dans le respect des consignes de sécurité fédérales. Le Locataire (ou son représentant légal) atteste être titulaire d'une licence FFTA en cours de validité pour la saison sportive couverte par la location, garantissant ainsi sa couverture en Responsabilité Civile. Il est seul responsable de l'utilisation de l'arc et des dommages matériels ou corporels causés à lui-même ou à des tiers du fait de ce matériel. L'utilisation du matériel en dehors des pas de tir agréés ou des compétitions officielles se fait sous l'entière responsabilité du Locataire.",
		"pdf_clause_entretien_reparations":  "L'adhérent prendra le plus grand soin du matériel confié et assurera son entretien courant (cirage de la corde, rangement à l'abri de l'humidité et des fortes chaleurs). Toute anomalie ou casse doit être signalée immédiatement au club. Les réparations liées à l'usure normale sont à la charge du club ; celles consécutives à une négligence ou mauvaise utilisation (ex: décochage à vide) ou le remplacement d'un accessoire perdu seront facturées à l'adhérent.",
